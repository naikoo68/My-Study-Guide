...
export default function PracticeQuizPlay() {
  ...
  // Optional deep-link / preview aid: `?timer=off|15|30|45|60` starts the quiz
  ...
  // This gives the questions a real, shareable/previewable URL. Absent/invalid
  // values leave the normal "choose a timer" flow untouched.
