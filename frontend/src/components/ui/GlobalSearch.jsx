...
export default function GlobalSearch({
  ...
  return (
    <div ref={boxRef} className={`relative ${className}`}>
      ...
      {showPanel && (
        <div className="absolute left-0 right-0 z-40 mt-2 max-h-96 overflow-y-auto rounded-xl border border-slate-200 bg-white p-2 text-left shadow-xl dark:border-slate-700 dark:bg-slate-900">
          {err ? (
