      ...
      <div className="min-h-full w-full max-w-none animate-scale-in card m-0 rounded-none p-4 sm:rounded-2xl sm:p-6">
          ...
          <>
            ...
            {plan.length > 0 && (
              <div className="mt-3 rounded-xl border border-brand-200 bg-brand-50/50 p-3 dark:border-brand-900/40 dark:bg-brand-900/10">
                ...
                <ul className="space-y-1 sm:max-h-56 sm:overflow-y-auto sm:overscroll-contain">
                  {plan.map((p, i) => {
            ...
            {perSubRun && (
              <div className="mt-2 rounded-lg border border-brand-200 bg-brand-50/60 px-3 py-2 text-xs dark:border-brand-900/40 dark:bg-brand-900/10">
                ...
                {(() => {
                  ...
                  return (
                    <ul className="mt-1.5 space-y-0.5 sm:max-h-40 sm:overflow-y-auto sm:overscroll-contain">
                      {perSubList.map((s, k) => (
            ...
            {!perSubRun && perSubList.length > 0 && (
              <div className="mt-2 rounded-lg border border-emerald-200 bg-emerald-50/60 px-3 py-2 text-xs dark:border-emerald-900/40 dark:bg-emerald-900/10">
                ...
                <ul className="space-y-0.5 sm:max-h-40 sm:overflow-y-auto sm:overscroll-contain">
                  {perSubList.map((s, k) => (
            ...
            {preview.length > 0 && (
              <div className="mt-4">
                ...
                {/* On phones this list flows into the modal's own scroll (an
                    inner scroll box nested inside the scrolling modal can't be
                    scrolled on iOS Safari — the gesture is captured by the
                    ...
                    <div className="grid gap-3 sm:grid-cols-2">
                      <div>
                        ...
                        {coverage.covered.length ? (
                          <ul className="space-y-1 text-xs text-slate-600 dark:text-slate-300 sm:max-h-44 sm:overflow-y-auto sm:overscroll-contain">
        ...
        {keyStats && Object.keys(keyStats).length > 0 && (
          <div className="mt-3 rounded-xl border border-slate-200 p-3 dark:border-slate-700">
            ...
            <div className="space-y-1 sm:max-h-40 sm:overflow-y-auto sm:overscroll-contain">
